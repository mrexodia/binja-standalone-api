...
BINARYNINJACOREAPI char* BNAllocString(const char* contents) { __debugbreak(); return {}; }
BINARYNINJACOREAPI void BNFreeString(char* str) { __debugbreak(); }
BINARYNINJACOREAPI char** BNAllocStringList(const char** contents, size_t size) { __debugbreak(); return {}; }
BINARYNINJACOREAPI void BNFreeStringList(char** strs, size_t count) { __debugbreak(); }
...
BINARYNINJACOREAPI bool BNInitPlugins(bool allowUserPlugins) { __debugbreak(); return {}; }
BINARYNINJACOREAPI bool BNInitCorePlugins(void) { __debugbreak(); return {}; }  // Deprecated, use BNInitPlugins
...
BINARYNINJACOREAPI void BNInitUserPlugins(void) { __debugbreak(); }  // Deprecated, use BNInitPlugins
...
BINARYNINJACOREAPI BNBinaryViewType* BNGetBinaryViewTypeByName(const char* name) { __debugbreak(); return {}; }
...
// Architectures
BINARYNINJACOREAPI BNArchitecture* BNGetArchitectureByName(const char* name) { __debugbreak(); return {}; }
BINARYNINJACOREAPI BNArchitecture** BNGetArchitectureList(size_t* count) { __debugbreak(); return {}; }
BINARYNINJACOREAPI void BNFreeArchitectureList(BNArchitecture** archs) { __debugbreak(); }
BINARYNINJACOREAPI BNArchitecture* BNRegisterArchitecture(const char* name, BNCustomArchitecture* arch) { __debugbreak(); return {}; }
...
BINARYNINJACOREAPI bool BNGetInstructionInfo(
	BNArchitecture* arch, const uint8_t* data, uint64_t addr, size_t maxLen, BNInstructionInfo* result) { __debugbreak(); return {}; }
BINARYNINJACOREAPI bool BNGetInstructionText(BNArchitecture* arch, const uint8_t* data, uint64_t addr, size_t* len,
	BNInstructionTextToken** result, size_t* count) { __debugbreak(); return {}; }
BINARYNINJACOREAPI bool BNGetInstructionLowLevelIL(
	BNArchitecture* arch, const uint8_t* data, uint64_t addr, size_t* len, BNLowLevelILFunction* il) { __debugbreak(); return {}; }
BINARYNINJACOREAPI void BNFreeInstructionText(BNInstructionTextToken* tokens, size_t count) { __debugbreak(); }
...
BINARYNINJACOREAPI void BNArchitectureRegisterRelocationHandler(
	BNArchitecture* arch, const char* viewName, BNRelocationHandler* handler) { __debugbreak(); }
BINARYNINJACOREAPI BNRelocationHandler* BNCreateRelocationHandler(BNCustomRelocationHandler* handler) { __debugbreak(); return {}; }
...
// Low-level IL
BINARYNINJACOREAPI BNLowLevelILFunction* BNCreateLowLevelILFunction(BNArchitecture* arch, BNFunction* func) { __debugbreak(); return {}; }
BINARYNINJACOREAPI BNLowLevelILFunction* BNNewLowLevelILFunctionReference(BNLowLevelILFunction* func) { __debugbreak(); return {}; }
BINARYNINJACOREAPI void BNFreeLowLevelILFunction(BNLowLevelILFunction* func) { __debugbreak(); }
BINARYNINJACOREAPI BNFunction* BNGetLowLevelILOwnerFunction(BNLowLevelILFunction* func) { __debugbreak(); return {}; }
...
BINARYNINJACOREAPI size_t BNLowLevelILAddExpr(BNLowLevelILFunction* func, BNLowLevelILOperation operation, size_t size,
	uint32_t flags, uint64_t a, uint64_t b, uint64_t c, uint64_t d) { __debugbreak(); return {}; }
BINARYNINJACOREAPI size_t BNLowLevelILAddExprWithLocation(BNLowLevelILFunction* func, uint64_t addr,
	...
	uint64_t c, uint64_t d) { __debugbreak(); return {}; }
BINARYNINJACOREAPI void BNLowLevelILSetExprSourceOperand(BNLowLevelILFunction* func, size_t expr, uint32_t operand) { __debugbreak(); }
BINARYNINJACOREAPI size_t BNLowLevelILAddInstruction(BNLowLevelILFunction* func, size_t expr) { __debugbreak(); return {}; }
BINARYNINJACOREAPI size_t BNLowLevelILGoto(BNLowLevelILFunction* func, BNLowLevelILLabel* label) { __debugbreak(); return {}; }
BINARYNINJACOREAPI size_t BNLowLevelILGotoWithLocation(
	BNLowLevelILFunction* func, BNLowLevelILLabel* label, uint64_t addr, uint32_t sourceOperand) { __debugbreak(); return {}; }
BINARYNINJACOREAPI size_t BNLowLevelILIf(
	BNLowLevelILFunction* func, uint64_t op, BNLowLevelILLabel* t, BNLowLevelILLabel* f) { __debugbreak(); return {}; }
BINARYNINJACOREAPI size_t BNLowLevelILIfWithLocation(BNLowLevelILFunction* func, uint64_t op, BNLowLevelILLabel* t,
	BNLowLevelILLabel* f, uint64_t addr, uint32_t sourceOperand) { __debugbreak(); return {}; }
BINARYNINJACOREAPI void BNLowLevelILInitLabel(BNLowLevelILLabel* label) { __debugbreak(); }
BINARYNINJACOREAPI void BNLowLevelILMarkLabel(BNLowLevelILFunction* func, BNLowLevelILLabel* label) { __debugbreak(); }
...
BINARYNINJACOREAPI size_t BNLowLevelILAddOperandList(BNLowLevelILFunction* func, uint64_t* operands, size_t count) { __debugbreak(); return {}; }
BINARYNINJACOREAPI uint64_t* BNLowLevelILGetOperandList(
	BNLowLevelILFunction* func, size_t expr, size_t operand, size_t* count) { __debugbreak(); return {}; }
BINARYNINJACOREAPI void BNLowLevelILFreeOperandList(uint64_t* operands) { __debugbreak(); }

BINARYNINJACOREAPI BNLowLevelILInstruction BNGetLowLevelILByIndex(BNLowLevelILFunction* func, size_t i) { __debugbreak(); return {}; }
BINARYNINJACOREAPI size_t BNGetLowLevelILIndexForInstruction(BNLowLevelILFunction* func, size_t i) { __debugbreak(); return {}; }
BINARYNINJACOREAPI size_t BNGetLowLevelILInstructionForExpr(BNLowLevelILFunction* func, size_t expr) { __debugbreak(); return {}; }
BINARYNINJACOREAPI size_t BNGetLowLevelILInstructionCount(BNLowLevelILFunction* func) { __debugbreak(); return {}; }
BINARYNINJACOREAPI size_t BNGetLowLevelILExprCount(BNLowLevelILFunction* func) { __debugbreak(); return {}; }
...
BINARYNINJACOREAPI bool BNGetLowLevelILExprText(BNLowLevelILFunction* func, BNArchitecture* arch, size_t i,
	BNDisassemblySettings* settings, BNInstructionTextToken** tokens, size_t* count) { __debugbreak(); return {}; }
...
BINARYNINJACOREAPI BNType* BNCreateVoidType(void) { __debugbreak(); return {}; }
BINARYNINJACOREAPI BNType* BNCreateBoolType(void) { __debugbreak(); return {}; }
BINARYNINJACOREAPI BNType* BNCreateIntegerType(size_t width, BNBoolWithConfidence* sign, const char* altName) { __debugbreak(); return {}; }
BINARYNINJACOREAPI BNType* BNCreateFloatType(size_t width, const char* altName) { __debugbreak(); return {}; }
BINARYNINJACOREAPI BNType* BNCreateWideCharType(size_t width, const char* altName) { __debugbreak(); return {}; }
...
BINARYNINJACOREAPI BNType* BNCreatePointerTypeOfWidth(size_t width, const BNTypeWithConfidence* const type,
	BNBoolWithConfidence* cnst, BNBoolWithConfidence* vltl, BNReferenceType refType) { __debugbreak(); return {}; }
BINARYNINJACOREAPI BNType* BNCreateArrayType(const BNTypeWithConfidence* const type, uint64_t elem) { __debugbreak(); return {}; }
...
BINARYNINJACOREAPI BNType* BNNewTypeReference(BNType* type) { __debugbreak(); return {}; }
...
BINARYNINJACOREAPI void BNFreeType(BNType* type) { __debugbreak(); }
...
BINARYNINJACOREAPI BNCallingConvention* BNCreateCallingConvention(
	BNArchitecture* arch, const char* name, BNCustomCallingConvention* cc) { __debugbreak(); return {}; }
BINARYNINJACOREAPI void BNRegisterCallingConvention(BNArchitecture* arch, BNCallingConvention* cc) { __debugbreak(); }
BINARYNINJACOREAPI BNCallingConvention* BNNewCallingConventionReference(BNCallingConvention* cc) { __debugbreak(); return {}; }
BINARYNINJACOREAPI void BNFreeCallingConvention(BNCallingConvention* cc) { __debugbreak(); }
...
BINARYNINJACOREAPI BNCallingConvention* BNGetArchitectureDefaultCallingConvention(BNArchitecture* arch) { __debugbreak(); return {}; }
BINARYNINJACOREAPI BNCallingConvention* BNGetArchitectureCdeclCallingConvention(BNArchitecture* arch) { __debugbreak(); return {}; }
BINARYNINJACOREAPI BNCallingConvention* BNGetArchitectureStdcallCallingConvention(BNArchitecture* arch) { __debugbreak(); return {}; }
BINARYNINJACOREAPI BNCallingConvention* BNGetArchitectureFastcallCallingConvention(BNArchitecture* arch) { __debugbreak(); return {}; }
BINARYNINJACOREAPI void BNSetArchitectureDefaultCallingConvention(BNArchitecture* arch, BNCallingConvention* cc) { __debugbreak(); }
BINARYNINJACOREAPI void BNSetArchitectureCdeclCallingConvention(BNArchitecture* arch, BNCallingConvention* cc) { __debugbreak(); }
BINARYNINJACOREAPI void BNSetArchitectureStdcallCallingConvention(BNArchitecture* arch, BNCallingConvention* cc) { __debugbreak(); }
BINARYNINJACOREAPI void BNSetArchitectureFastcallCallingConvention(BNArchitecture* arch, BNCallingConvention* cc) { __debugbreak(); }
...
// Settings APIs
BINARYNINJACOREAPI BNSettings* BNCreateSettings(const char* schemaId) { __debugbreak(); return {}; }
BINARYNINJACOREAPI BNSettings* BNNewSettingsReference(BNSettings* settings) { __debugbreak(); return {}; }
BINARYNINJACOREAPI void BNFreeSettings(BNSettings* settings) { __debugbreak(); }
...
BINARYNINJACOREAPI bool BNSettingsRegisterSetting(BNSettings* settings, const char* key, const char* properties) { __debugbreak(); return {}; }
